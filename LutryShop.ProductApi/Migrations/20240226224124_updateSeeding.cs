    ...
    public partial class updateSeeding : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2L,
                columns: new[] { "CategoryName", "Description", "ImageURL", "Name", "Price" },
                values: new object[] { "Seed Category Name 2", "Seed Description 2", "Seed ImageURL 2", "Seed Name 2", 2m });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3L,
                columns: new[] { "CategoryName", "Description", "ImageURL", "Name", "Price" },
                values: new object[] { "Seed Category Name 3", "Seed Description 3", "Seed ImageURL 3", "Seed Name 3", 3m });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 4L,
                columns: new[] { "CategoryName", "Description", "ImageURL", "Name", "Price" },
                values: new object[] { "Seed Category Name 4", "Seed Description 4", "Seed ImageURL 4", "Seed Name 4", 4m });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryName", "Description", "ImageURL", "Name", "Price" },
                values: new object[] { 1L, "Seed Category Name 1", "Seed Description 1", "Seed ImageURL 1", "Seed Name 1", 1m });
        }
    }
}
